...
class HrAttendance(models.Model):
    ...
    @api.depends('check_in', 'check_out', 'employee_id.resource_calendar_id.worksheet_ids',
                 'check_in_is_corrected', 'check_out_is_corrected', 'was_missing_checkin', 'was_missing_checkout')
    def _compute_status_ids(self):
        ...
        for att in self:
            ...
            if att.was_missing_checkin and not att.check_in_is_corrected:
                status_flags.add("Missed checkin")
            if att.was_missing_checkout and not att.check_out_is_corrected:
